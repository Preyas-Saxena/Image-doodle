...
# datacp = datapairs_copy(filename='valid_no_dup_trim.json')
# print(len(datacp))
# print(datacp)

# print((datacp.__getitem__(0)))

# print(datacp.category2ims)
# print (datacp.im2type)
# print(datacp.im2type[str(209512492)][1])
# print(datacp.negative_samples(209512492,1))
